...
tail -n +2 04_salmon_alignment_quant/mouse_110_WT_C/quant.genes.sf | cut -f1 > 06-Counts/tmp/geneids.txt
...
cat <(cat samples.txt | sort | paste -s) 06-Counts/tmp/tmp.out > 06-Counts/rnaseq_salmon_workshop_counts.txt
rm -rf 06-Counts/tmp
